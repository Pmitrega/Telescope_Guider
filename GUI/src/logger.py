...
class Logger:
    def __init__(self):
        ...
        self.ra_ctrl_path =  "./logs/" + date + "/" + formatted_time + "_ra_ctrl.csv"
        self.dec_ctrl_path = "./logs/" + date + "/" + formatted_time + "_dec_ctrl.csv"
        self.x_err_path =    "./logs/" + date + "/" + formatted_time + "_x_err.csv"
        self.y_err_path =    "./logs/" + date + "/" + formatted_time + "_y_err.csv"
        self.x_SP_path =     "./logs/" + date + "/" + formatted_time + "_x_SP.csv"
        self.y_SP_path =     "./logs/" + date + "/" + formatted_time + "_y_SP.csv"
