...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QRect(9, 9, 971, 121))
        ...
        self.label_59 = QLabel(self.horizontalLayoutWidget_2)
        ...
        self.label_59.setMaximumSize(QSize(200, 25))
        font1 = QFont()
        ...
        self.comboBox_controller = QComboBox(self.horizontalLayoutWidget_2)
        self.comboBox_controller.addItem("")
        self.comboBox_controller.addItem("")
        self.comboBox_controller.addItem("")
        self.comboBox_controller.setObjectName(u"comboBox_controller")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.comboBox_controller.sizePolicy().hasHeightForWidth())
        self.comboBox_controller.setSizePolicy(sizePolicy5)
        self.comboBox_controller.setMaximumSize(QSize(200, 16777215))
        self.comboBox_controller.setEditable(True)

        self.verticalLayout_7.addWidget(self.comboBox_controller)

        self.horizontalLayout_6 = QHBoxLayout()
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.label_60 = QLabel(self.horizontalLayoutWidget_2)
        self.label_60.setObjectName(u"label_60")
        sizePolicy4.setHeightForWidth(self.label_60.sizePolicy().hasHeightForWidth())
        self.label_60.setSizePolicy(sizePolicy4)
        self.label_60.setMaximumSize(QSize(100, 25))
        ...
        self.doubleSpinBox_P_gain = QDoubleSpinBox(self.horizontalLayoutWidget_2)
        self.doubleSpinBox_P_gain.setObjectName(u"doubleSpinBox_P_gain")
        self.doubleSpinBox_P_gain.setSingleStep(0.100000000000000)
        self.doubleSpinBox_P_gain.setValue(2.000000000000000)

        self.horizontalLayout_6.addWidget(self.doubleSpinBox_P_gain)

        self.label_62 = QLabel(self.horizontalLayoutWidget_2)
        self.label_62.setObjectName(u"label_62")
        sizePolicy4.setHeightForWidth(self.label_62.sizePolicy().hasHeightForWidth())
        self.label_62.setSizePolicy(sizePolicy4)
        self.label_62.setMaximumSize(QSize(100, 25))
        ...
        self.doubleSpinBox_I_gain = QDoubleSpinBox(self.horizontalLayoutWidget_2)
        self.doubleSpinBox_I_gain.setObjectName(u"doubleSpinBox_I_gain")
        self.doubleSpinBox_I_gain.setSingleStep(0.100000000000000)

        self.horizontalLayout_6.addWidget(self.doubleSpinBox_I_gain)

        self.label_61 = QLabel(self.horizontalLayoutWidget_2)
        self.label_61.setObjectName(u"label_61")
        sizePolicy4.setHeightForWidth(self.label_61.sizePolicy().hasHeightForWidth())
        self.label_61.setSizePolicy(sizePolicy4)
        self.label_61.setMaximumSize(QSize(100, 25))
        ...
        self.doubleSpinBox_D_gain = QDoubleSpinBox(self.horizontalLayoutWidget_2)
        self.doubleSpinBox_D_gain.setObjectName(u"doubleSpinBox_D_gain")
        self.doubleSpinBox_D_gain.setSingleStep(0.100000000000000)

        self.horizontalLayout_6.addWidget(self.doubleSpinBox_D_gain)
        ...
        self.verticalLayout_38.addWidget(self.pushButton_7)
        ...
        sizePolicy5.setHeightForWidth(self.lineEdit_detected.sizePolicy().hasHeightForWidth())
        self.lineEdit_detected.setSizePolicy(sizePolicy5)
        ...
        self.doubleSpinBox = QDoubleSpinBox(self.tab_8)
        self.doubleSpinBox.setObjectName(u"doubleSpinBox")
        self.doubleSpinBox.setGeometry(QRect(130, 10, 62, 25))
        ...
        self.label_55.setGeometry(QRect(20, 10, 100, 25))
        sizePolicy4.setHeightForWidth(self.label_55.sizePolicy().hasHeightForWidth())
        self.label_55.setSizePolicy(sizePolicy4)
        self.label_55.setMinimumSize(QSize(70, 0))
        self.label_55.setMaximumSize(QSize(100, 25))
        self.label_55.setFont(font1)
        self.label_55.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.doubleSpinBox_2 = QDoubleSpinBox(self.tab_8)
        self.doubleSpinBox_2.setObjectName(u"doubleSpinBox_2")
        self.doubleSpinBox_2.setGeometry(QRect(130, 40, 62, 25))
        self.doubleSpinBox_2.setMinimum(-90.000000000000000)
        self.doubleSpinBox_2.setMaximum(90.000000000000000)
        self.label_56 = QLabel(self.tab_8)
        self.label_56.setObjectName(u"label_56")
        self.label_56.setGeometry(QRect(0, 40, 70, 25))
        sizePolicy4.setHeightForWidth(self.label_56.sizePolicy().hasHeightForWidth())
        self.label_56.setSizePolicy(sizePolicy4)
        self.label_56.setMinimumSize(QSize(70, 0))
        self.label_56.setMaximumSize(QSize(100, 25))
        ...
        self.pushButton_5.setGeometry(QRect(20, 100, 175, 24))
        sizePolicy2.setHeightForWidth(self.pushButton_5.sizePolicy().hasHeightForWidth())
        self.pushButton_5.setSizePolicy(sizePolicy2)
        self.pushButton_5.setMaximumSize(QSize(190, 16777215))
        self.lineEdit_curr_dec = QLineEdit(self.tab_8)
        self.lineEdit_curr_dec.setObjectName(u"lineEdit_curr_dec")
        self.lineEdit_curr_dec.setGeometry(QRect(200, 10, 71, 24))
        sizePolicy5.setHeightForWidth(self.lineEdit_curr_dec.sizePolicy().hasHeightForWidth())
        self.lineEdit_curr_dec.setSizePolicy(sizePolicy5)
        self.lineEdit_curr_dec.setMaximumSize(QSize(200, 16777215))
        self.lineEdit_curr_dec.setReadOnly(True)
        self.lineEdit_curr_hr = QLineEdit(self.tab_8)
        self.lineEdit_curr_hr.setObjectName(u"lineEdit_curr_hr")
        self.lineEdit_curr_hr.setGeometry(QRect(200, 40, 71, 24))
        sizePolicy5.setHeightForWidth(self.lineEdit_curr_hr.sizePolicy().hasHeightForWidth())
        self.lineEdit_curr_hr.setSizePolicy(sizePolicy5)
        self.lineEdit_curr_hr.setMaximumSize(QSize(200, 16777215))
        self.lineEdit_curr_hr.setReadOnly(True)
        self.pushButton_6 = QPushButton(self.tab_8)
        self.pushButton_6.setObjectName(u"pushButton_6")
        self.pushButton_6.setGeometry(QRect(300, 30, 175, 24))
        sizePolicy2.setHeightForWidth(self.pushButton_6.sizePolicy().hasHeightForWidth())
        self.pushButton_6.setSizePolicy(sizePolicy2)
        self.pushButton_6.setMaximumSize(QSize(190, 16777215))
        self.label_57 = QLabel(self.tab_8)
        self.label_57.setObjectName(u"label_57")
        self.label_57.setGeometry(QRect(280, 0, 350, 31))
        ...
        self.label_57.setMaximumSize(QSize(350, 16777215))
        font4 = QFont()
        font4.setFamilies([u"Segoe UI Historic"])
        font4.setPointSize(8)
        font4.setWeight(QFont.DemiBold)
        font4.setUnderline(True)
        self.label_57.setFont(font4)
        self.label_57.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.comboBox_address_3 = QComboBox(self.tab_8)
        self.comboBox_address_3.addItem("")
        self.comboBox_address_3.addItem("")
        self.comboBox_address_3.setObjectName(u"comboBox_address_3")
        self.comboBox_address_3.setGeometry(QRect(480, 30, 131, 24))
        sizePolicy2.setHeightForWidth(self.comboBox_address_3.sizePolicy().hasHeightForWidth())
        self.comboBox_address_3.setSizePolicy(sizePolicy2)
        self.comboBox_address_3.setMaximumSize(QSize(200, 16777215))
        self.comboBox_address_3.setEditable(True)
        self.lineEdit_curr_dec_delta = QLineEdit(self.tab_8)
        self.lineEdit_curr_dec_delta.setObjectName(u"lineEdit_curr_dec_delta")
        self.lineEdit_curr_dec_delta.setGeometry(QRect(200, 70, 71, 24))
        sizePolicy5.setHeightForWidth(self.lineEdit_curr_dec_delta.sizePolicy().hasHeightForWidth())
        self.lineEdit_curr_dec_delta.setSizePolicy(sizePolicy5)
        self.lineEdit_curr_dec_delta.setMaximumSize(QSize(200, 16777215))
        self.lineEdit_curr_dec_delta.setReadOnly(True)
        self.label_58 = QLabel(self.tab_8)
        self.label_58.setObjectName(u"label_58")
        self.label_58.setGeometry(QRect(10, 70, 100, 25))
        sizePolicy4.setHeightForWidth(self.label_58.sizePolicy().hasHeightForWidth())
        self.label_58.setSizePolicy(sizePolicy4)
        self.label_58.setMinimumSize(QSize(70, 0))
        self.label_58.setMaximumSize(QSize(100, 25))
        ...
        self.verticalLayoutWidget_8.setGeometry(QRect(10, 60, 181, 56))
        ...
        self.verticalLayoutWidget_14.setGeometry(QRect(10, 120, 181, 168))
        ...
        self.checkBox_show_set_point = QCheckBox(self.verticalLayoutWidget_14)
        self.checkBox_show_set_point.setObjectName(u"checkBox_show_set_point")
        sizePolicy5.setHeightForWidth(self.checkBox_show_set_point.sizePolicy().hasHeightForWidth())
        self.checkBox_show_set_point.setSizePolicy(sizePolicy5)
        self.checkBox_show_set_point.setMaximumSize(QSize(160, 16777215))
        self.checkBox_show_set_point.setChecked(True)

        self.verticalLayout_16.addWidget(self.checkBox_show_set_point)
        ...
        self.checkBox_save_raw.setFont(font5)
        ...
        sizePolicy5.setHeightForWidth(self.label_solver_status.sizePolicy().hasHeightForWidth())
        self.label_solver_status.setSizePolicy(sizePolicy5)
        ...
        self.lineEdit_sky_ra.setFont(font7)
        ...
        self.pushButton_7.clicked.connect(MainWindow.reselectGuidingStar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_59.setText(QCoreApplication.translate("MainWindow", u"Controller type", None))
        self.comboBox_controller.setItemText(0, QCoreApplication.translate("MainWindow", u"PID", None))
        self.comboBox_controller.setItemText(1, QCoreApplication.translate("MainWindow", u"WCS_FF_PID", None))
        self.comboBox_controller.setItemText(2, QCoreApplication.translate("MainWindow", u"Adaptive_PID", None))

        self.label_60.setText(QCoreApplication.translate("MainWindow", u"P", None))
        self.label_62.setText(QCoreApplication.translate("MainWindow", u"I", None))
        self.label_61.setText(QCoreApplication.translate("MainWindow", u"D", None))
        ...
        self.pushButton_7.setText(QCoreApplication.translate("MainWindow", u"Reselect Guiding Star", None))
        ...
        self.label_55.setText(QCoreApplication.translate("MainWindow", u"Telescope Dec", None))
        self.label_56.setText(QCoreApplication.translate("MainWindow", u"Phi", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"Setup", None))
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"Auto Identification", None))
        self.label_57.setText(QCoreApplication.translate("MainWindow", u"Before identification solve field and select quater !", None))
        self.comboBox_address_3.setItemText(0, QCoreApplication.translate("MainWindow", u"90 to -90 right", None))
        self.comboBox_address_3.setItemText(1, QCoreApplication.translate("MainWindow", u"90 to -90 left", None))

        self.label_58.setText(QCoreApplication.translate("MainWindow", u"Dec Delta", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), QCoreApplication.translate("MainWindow", u"Identify/Setup Telescope", None))
        ...
        self.checkBox_show_set_point.setText(QCoreApplication.translate("MainWindow", u"Show Set Point", None))
